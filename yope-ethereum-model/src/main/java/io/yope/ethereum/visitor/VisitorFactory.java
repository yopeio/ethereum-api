...
public class VisitorFactory {
    ...
    public static<T> BlockchainVisitor build(final String accountAddress, final String pwd, final String name, final String content, final T model, Method method) {
